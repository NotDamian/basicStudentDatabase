...
#include <fstream>
#include <cstdlib>
//#include<Windows.h> //dziala z windowsem
#include <unistd.h>  // funkcja usleep
...
void TablicaStudentow::dodaj(){
    if (iloscStu == 20) {
        cout << "Baza danych jest pełna..." << endl;
        usleep(4000000);
        menu();
    }
    ...
    while (getline(plik, linia))
    {
        switch (nr_li){
            ...
            case 2:
                    ...
                    break;
            case 3:
                    tab[iloscStu].wiek = atoi(linia.c_str()); //atoi konwersja z string na int
                    break;
            case 4:
